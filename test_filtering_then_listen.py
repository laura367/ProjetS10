...
wav_loc = "Test_environ_1m_avec_voiture.wav"
...
wavfile.write(os.path.join("/home/laura/Bureau/ProjetS10/traitement_wav", f'Other_algo_1m_with_car'), 44100, output)
...
wavfile.write(os.path.join("/home/laura/Bureau/ProjetS10/traitement_wav", f'BisOther_algo_1m_with_car'), 44100, output)